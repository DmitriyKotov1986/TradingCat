...
public:
    Binance(const TradingCatCommon::StockExchangeConfig& config, const Common::HTTPSSLQuery::ProxyList& proxyList, QObject* parent = nullptr);
    ~Binance();
...
private:
    ...
    std::list<TradingCatCommon::KLineID> _money; ///< Список доступных свечей
